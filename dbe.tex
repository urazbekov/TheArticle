...
Differential cross sections for the reaction channel ${^9}$Be($d$,$\alpha$)$^7$Li has been calculated including  both the deuteron and heavy cluster $^5$He pickup reaction mechanisms. The contributions of two-step pickup processes of the $n+p$ and $n+\alpha$ systems to cross section of the ${^9}$Be($d$,$\alpha$)$^7$Li  nuclear reaction are demonstrated.
